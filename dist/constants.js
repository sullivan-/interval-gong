...
// ============================================
export const TESTING_MODE = true; // Auto-starts gong on page load when true
// ============================================
...
export const GONG_DURATION_RULES = [
    { minInterval: 60, gongDuration: 6.0 }, // 1 minute and up: 3 second gong
    { minInterval: 30, gongDuration: 5.0 }, // 30 seconds and up: 2 second gong
    { minInterval: 2, gongDuration: 1.5 }, // 2 seconds and up: 1 second gong
    { minInterval: 0, gongDuration: 0.8 } // Less than 2 seconds: 0.5 second gong
];
